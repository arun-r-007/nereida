...
- Fish catch records  
- Oceanographic parameters (temperature, salinity, pH)  
...
- eDNA-driven hidden species discovery  
- Interactive multilingual dashboards  
...
- Trend charts  
- Scatter plots  
- Multilingual access for communities  
...
- Mercator Ocean Research & Innovation (GLONET Forecasting)  
- Kühn et al., 2024 – Machine Learning Applications for Fisheries  
- König et al., 2019 – Biodiversity Data Integration  
- Zhao et al., 2024 – Deep Learning in Physical Oceanography  
...
- AI-driven climate anomaly detection  
- Blockchain-based fisheries tracking  
- Integration with government marine portals  
